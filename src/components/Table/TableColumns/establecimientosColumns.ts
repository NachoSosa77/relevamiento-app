...
const ESTABLECIMIENTOS_COLUMNS = [
    { Header: 'Establecimiento', accessor: 'institucion' as keyof InstitucionesData },
    { Header: 'Modalidad/Nivel', accessor: 'modalidad_nivel' as keyof InstitucionesData },
    ...
    { Header: 'Departamento', accessor: 'departamento' as keyof InstitucionesData },
    { Header: 'Localidad/Paraje', accessor: 'localidad' as keyof InstitucionesData },
];
