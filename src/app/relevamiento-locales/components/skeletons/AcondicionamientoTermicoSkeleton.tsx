export default function AcondicionamientoTermicoSkeleton() {
  return (
    <div className="h-full bg-white text-black text-sm mt-10 animate-pulse">
      <div className="mx-10 mt-4">
        ...
        {/* Skeleton para inputs de cantidad y radios */}
        {[...Array(4)].map((_, i) => (
          <div key={i} className="mt-4 flex flex-col gap-2 border p-3 rounded">
