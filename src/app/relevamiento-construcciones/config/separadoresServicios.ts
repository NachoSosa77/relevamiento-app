...
export const caracteristicasConstruccion = {
  label: "CARACTERÍSTICAS CONSTRUCTIVAS Y ESTADO DE CONSERVACIÓN",
  value:
    "Para cada una de las características constructivas listadas, indique -por observación- cúal es la estructura predominante. Para cada un de las estructuras o materiales predominantes, indique -por observación- el estado de conservación.",
};
