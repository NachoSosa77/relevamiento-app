...
export default function SeguridadIncendio({
  ...
  const [responses, setResponses] = useState<
    Record<string, { disponibilidad: string; estado: string; cantidad: string, ubicacion: string }>
  >({});
      ...
      >
        {!showCondition ? (
          ...
          <div className="flex gap-2 items-center justify-center">
            ...
            {(id === "7.2" || id === "7.7") && (
              <TextInput
                label={id === "7.2" ? "Cantidad de bocas de incendio" : "Cantidad de salidas"}
                sublabel=""
                ...
                <div className="flex gap-2 items-center justify-center">
                  ...
                  <label>
                    <input
                      ...
                      name={`carga-anual-${id}`}
                      value="No sabe"
                      onChange={() => handleResponseChange(id, "disponibilidad", "No sabe")}
                      className="mr-1"
                    />
                    NS
                  </label>
              ...
              <div className="flex gap-4 items-center justify-center">
                <label>
                  <input
                    ...
                    name={`ubicacion-${id}`}
                    value="En todas"
                    onChange={() => handleResponseChange(id, "ubicacion", "En todas")}
                    className="mr-1"
                  />
                  En todas
                </label>
                <label>
                  <input
                    ...
                    name={`ubicacion-${id}`}
                    value="En algunas"
                    onChange={() => handleResponseChange(id, "ubicacion", "En algunas")}
                    className="mr-1"
                  />
                  En algunas
                </label>
                <label>
                  <input
                    ...
                    name={`ubicacion-${id}`}
                    value="En ninguna"
                    onChange={() => handleResponseChange(id, "ubicacion", "En ninguna")}
                    className="mr-1"
                  />
                  En ninguna
                </label>
            ...
            {id === "7.11" && (
              ...
              <label>
                <input
                  ...
                  name={`disponibilidad-${id}`}
                  value="Sólo PB"
                  onChange={() => handleResponseChange(id, "disponibilidad", "Sólo PB")}
                  className="mr-1"
                />
                Sólo PB
              </label>
            ...
            {id === "7.15" && (
              ...
              <label>
                <input
                  ...
                  name={`ubicacion-${id}`}
                  value="En todos"
                  onChange={() => handleResponseChange(id, "ubicacion", "En todos")}
                  className="mr-1"
                />
                En todos
              </label>
              <label>
                <input
                  ...
                  name={`ubicacion-${id}`}
                  value="En algunos"
                  onChange={() => handleResponseChange(id, "ubicacion", "En algunos")}
                  className="mr-1"
                />
                En algunos
              </label>
              <label>
                <input
                  ...
                  name={`ubicacion-${id}`}
                  value="En ninguno"
                  onChange={() => handleResponseChange(id, "ubicacion", "En ninguno")}
                  className="mr-1"
                />
                En ninguno
              </label>
              <label>
                <input
                  ...
                  name={`ubicacion-${id}`}
                  value="Ns"
                  onChange={() => handleResponseChange(id, "ubicacion", "Ns")}
                  className="mr-1"
                />
                NS
              </label>
