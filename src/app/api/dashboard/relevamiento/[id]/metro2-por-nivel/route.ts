...
/**
 * GET /api/dashboard/relevamiento/[id]/metros2-por-nivel
 *
 * - Misma lógica que /api/dashboard/metros2-por-nivel,
 *   pero para UN solo relevamiento (resumen del relevamiento).
...
export async function GET(
  ...
  try {
    ...
    const totalM2 = (rows || []).reduce(
      (acc: number, r: any) => acc + Number(r.m2 || 0),
      0
    );
